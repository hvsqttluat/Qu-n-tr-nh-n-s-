...
Đây là thư mục bàn giao cho đề tài **Phần mềm quản lý nhân sự - Nhóm 3**.

Sau khi giải nén, mở theo thứ tự:
...
Khi thầy hỏi phần thiết kế giao diện, có 2 cách chỉ:

1. Mở **Mã nguồn**, giải nén file mã nguồn, mở `QuanLyNhanSuWpf.sln` bằng Visual Studio, sau đó mở `QuanLyNhanSuWpf/ThietKeGiaoDienWindow.xaml` và chọn chế độ **Design** hoặc **Split**.
2. Mở thư mục **Thiết kế UI UX Figma/Thiết kế từng phân hệ** để xem bộ wireframe dạng file SVG.
